				...
				<div className='row'>
					...
					<div className='col-md-4'>
						...
						<p className="text-justify">
							...
							<p>{`With a single contact, you'll also been suring that the build quality will be kept to the same high standard; no taking chances on different contractors who may work differently from others. You'll be working with office fit out experts who will manage the project from start to finish; so, no worrying about red tape or complicated regulations.`}</p>
						</p>
					</div>
				</div>
			</div>
