	...
	return (
		<div>
			...
			<div className='container ptb-110'>
				<p>
					{`
					From a blank canvas through to the project handover and aftercare, we
					work to create spaces that inspire staff, enrich culture and improve
					recruitment and retention. Ultimately, they will help to bring people
					together to create the products and services that will make your
					business a success.`}
				</p>
				<div className='row'>
