		...
		<div>
			...
			<div className='container mt-8'>
				<div className='intro mt-5 mb-3'>
					<h2 className='text-center text-dark'>Institute Francais </h2>
				...
				<div className='row '>
					<div className='col-lg-3 col-md-6'>
						<Image
							...
							src='/images/institutfrancais/1.jpg'
							alt='project1'
						/>
					</div>
					...
					<div className='col-lg-3 col-md-6'>
						<Image
							...
							height={400}
							className='content-image'
							src='/images/institutfrancais/2.jpg'
							alt='project1'
						/>
					</div>
					...
					<div className='col-lg-3 col-md-6'>
						<Image
							...
							height={400}
							className='content-image'
							src='/images/institutfrancais/3.jpg'
							alt='project1'
						/>
					</div>
					...
					<div className='col-lg-3 col-md-6'>
						<Image
							...
							height={400}
							className='content-image'
							src='/images/institutfrancais/4.jpg'
							alt='project1'
						/>
					</div>
					<div className='col-lg-3 col-md-6'>
					...
					<div className='col-lg-3 col-md-6'>
						<Image
							...
							height={400}
							className='content-image'
							src='/images/institutfrancais/cover1.jpg'
							alt='project1'
						/>
					</div>
				</div>
